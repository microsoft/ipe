...
_policy_name = "fsverity_measurement"

class FSVerityMeasurementTests(IPETestCase):

    def __init__(self, methodName='runtTest', argv={}, tests=set()):
        super(FSVerityMeasurementTests, self).__init__(methodName, argv, tests)
    ...
    def setUpClass(cls):
        ...
        util.new_ipe_poilcy(cls._securityfs, f"{cls._policy}/test_func/p7s/fsverity_measurement.p7s")
...
#        self.skipTest('FSVerity measurement does not support this test')
